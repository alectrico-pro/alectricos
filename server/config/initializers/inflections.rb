...
# (all these examples are active by default):
 ActiveSupport::Inflector.inflections do |inflect|
    ...
    inflect.irregular 'levantamiento', 'levantamientos'
    ...
    inflect.irregular 'gente' , 'gentes'
    inflect.irregular 'orden' , 'ordenes'
    inflect.irregular 'item'  , 'itemes'
    inflect.irregular 'categoria', 'categorias'
    inflect.irregular 'electrico_categoria', 'electrico_categorias'
    inflect.irregular 'notificacion', 'notificaciones'
    inflect.irregular 'clonacion', 'clonaciones'
    inflect.irregular 'copia', 'copias'
    inflect.irregular 'original', 'originales'
    inflect.irregular 'entrega', 'entregas'
    inflect.irregular 'solicitud', 'solicitudes'
    inflect.irregular 'rendicion', 'rendiciones'
    inflect.irregular 'desuscripcion', 'desuscripciones'
end
