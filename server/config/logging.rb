...
#  layout = Logging.layouts.pattern(:pattern => '[%d] %-5l %c : %m\n')
  ...
  %w(
    Rails
   ).each{ |clase| Logging.logger[clase].level = :fatal}
  ...
  %w(
    ...
    Electrico::Solicitud
    Electrico::SolicitudCompartida
    Electrico::UserMailer
    ...
    D::Instalacion
    D::Trafo
    Curso::ModulosController
    Curso::EnrolamientosController
    Curso::ContenidosController
    Curso::ParticipantesController
    Curso::AlternativasController
    Curso::ObjetivosController
    Curso::TemasController
    Curso::TiposController
    Curso::PreguntasController
    Curso::PruebasController
    Curso::RespuestasController
    Curso::ExamenesController
    Curso::PartesController
    Electrico::PresupuestosController
    Electrico::CircuitosController
    D::EquipoMedida
    D::EntradaTrafo
    D::SalidaTrafo
    D::Barra
    D::Empalme
    Gestion::AtencionesController
    Gestion::CriteriosController
    Gestion::TipoAuditoriasController
    Gestion::Usuario
    Curso::LevantamientosController
    Amp::AccesosController
    Electrico::ProyectosController
    D::Is
    D::CortoCircuitoTrifasicoSimetricoBT
    D::FallaATierraTrifasicaBT
    D::FallaATierraBifasica
    D::CortoCircuitoBifasicoBT
    D::Alimentador
    D::CircuitoAlimentador
    D::CircuitoEnchufe
    D::CircuitoAlumbrado
    D::Disyuntor
  ...
  %w(
   ...
   ).each{ |clase| Logging.logger[clase].level = :debug}
  ...
  # writing.
  if Rails.env.test? or Rails.env.production? or Rails.env.development?
